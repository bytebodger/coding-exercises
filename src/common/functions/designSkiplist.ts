/*
   ...
   You can see there are many layers in the Skiplist. Each layer is a sorted linked list. With the help of the
   top layers, add, erase and search can be faster than O(n). It can be proven that the average time complexity
...
export class Skiplist {
   ...
   search = (target: number) => target in this.counts;
